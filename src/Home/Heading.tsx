        ...
        <div className="px-12 pt-12 antialiased">
            <div className="flex flex-col">
                ...
                <p className="w-max-w text-center leading-8 md:w-1/2 md:text-left lg:w-1/3 xl:w-1/4">
                    Hi, I am a second year student at University of Waterloo! I am interested in all
                    aspects of design and software development, especially after my recent
                    internships where I worked in full-stack development. You can read more about my
                    experiences in my{' '}
